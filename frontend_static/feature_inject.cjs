...
<script>
  window.addEventListener('load', () => {
      setTimeout(() => {
          ...
          if (!bellSvg) return;
          const bellBtn = bellSvg.closest('button');
          if (!bellBtn) return;
          ...
          overlay.innerHTML = \`
            ...
            <div id="copilot-suggestions">
                <div class="suggestion-chip">Hi!</div>
                ...
                <div class="suggestion-chip">Who is in Engineering?</div>
                <div class="suggestion-chip">Who is the HR Manager?</div>
