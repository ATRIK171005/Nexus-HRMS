...
const customScript = `
<script>
  // Add floating dark mode toggle button after React loads
  document.addEventListener('DOMContentLoaded', () => {
      ...
      // Insert to document body to avoid breaking React DOM hydration in #root
...
console.log('Restored and injected safely!');
